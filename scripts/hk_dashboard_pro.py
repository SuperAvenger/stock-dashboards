    ...
    for stock in stocks_data:
        ...
        <div class="card">
            ...
            <div class="price-section">
                <div class="current-price">HK$ {stock['current']}</div>
...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .stock-info h2 {{ font-size: 1.5em; margin-bottom: 5px; }}
        ...
        .price-change {{ font-size: 1.3em; font-weight: bold; }}
        ...
        .metric-value {{ font-size: 1.3em; font-weight: bold; color: #fbbf24; }}
...
def main():
    ...
    print(f"📋 股票池：{len(MONITOR_STOCKS)} 只")
